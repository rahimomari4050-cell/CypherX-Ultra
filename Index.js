...
const BOT_NAME = "Nexus AI Premier";
const PREFIX = "!";
const OWNER = "255610374713@s.whatsapp.net"; // Weka namba yako
...
const commands = {
    "menu": async (sock, msg) => {
        ...
        txt += `*!ai [swali]* - Uliza Nexus AI\n`;
        txt += `*!github [repo] [file]* - Vuta code\n`;
        txt += `*!owner* - Namba ya mkuu\n\n`;
        txt += `_Powered by Nexus PreModi_`;
...
async function startBot() {
    ...
    sock.ev.on('connection.update', (u) => {
        if (u.connection === 'close') {
            ...
            console.log('✅ NEXUS BOT PREMIER IMEWAKA');
